...
pg_dump --no-tablespaces -s -O -x -t "backend|marker*|categories|dynpoi_class|class|items|sources|sources_password|stats|dynpoi_status|dynpoi_status_id_seq|updates|updates_last" -h "$DB_HOST" -U osmose osmose_frontend >> schema.sql
