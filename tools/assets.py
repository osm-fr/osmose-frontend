...
css_map_bundle = Bundle(
    ...
    'map/leaflet-sidebar/L.Control.Sidebar.css',
    'map/leaflet-control-geocoder/Control.Geocoder.css',
    'map/leaflet-loading/Control.Loading.css',
    'map/leaflet-responsive-popup/leaflet.responsive.popup.css',
...
js_map_bundle = Bundle(
    ...
    'map/leaflet-sidebar/L.Control.Sidebar.js',
    'map/leaflet-control-geocoder/Control.Geocoder.js',
    'map/leaflet-active-area/leaflet.activearea.js',
    'map/leaflet-loading/Control.Loading.js',
    "map/leaflet-responsive-popup/leaflet.responsive.popup.js",
    'map/Location.js',
