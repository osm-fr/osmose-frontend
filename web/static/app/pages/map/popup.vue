    ...
    <div id="popup-{%id%}">
      <div class="bulle_msg">
        ...
        <div class="bulle_elem">
          ...
          <a
            target="_blank"
            href="http://analyser.openstreetmap.fr/cgi-bin/index.py?relation={%id%}"
          >
            analyse1
          </a>
          <a
            target="_blank"
            href="http://polygons.openstreetmap.fr/~osmbin/analyse-relation-open.py?{%id%}"
          >
            analyse2
          </a>
          {%/relation%} {%#node%}
          <a
            href="../josm_proxy?load_object?objects=n{%id%}"
            target="hiddenIframe"
            class="josm"
          ...
          {%/node%} {%#way%}
          <a
            href="../josm_proxy?load_object?objects=w{%id%}'"
            target="hiddenIframe"
            class="josm"
            :title="$t('Edit Object with {where}', { where: 'JOSM' })"
          >
          ...
          {%/way%} {%#relation%}
          <a
            href="'../josm_proxy?import?url=' + API_URL + '/api/0.6/{%type%}/{%id%}/full'"
            target="hiddenIframe"
            class="josm"
            :title="$t('Edit Object with {where}', { where: 'JOSM' })"
            onclick="$.get('../josm_proxy?zoom?left={%minlon%}&bottom={%minlat%}&right={%maxlon%}&top={%maxlat%}'); return true;"
          >
            josm
          </a>
          <a
      ...
      <div class="bulle_verif">
        ...
        <a
          href="../josm_proxy?load_and_zoom?left={%minlon%}&bottom={%minlat%}&right={%maxlon%}&top={%maxlat%}&select={%elems_id%}"
          target="hiddenIframe"
          class="josm"
