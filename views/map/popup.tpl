...
{%#elems%}
  ...
  {%/relation%}
      <a href="#" class="editor_edit" data-type="{%type%}" data-id="{%id%}" data-error="{%uuid%}" title="{{_('Edit Object with {where}').format(where=_('online Osmose Editor'))}}">edit</a>
      <br>
  {%#fixes%}
      <div class="fix">
        <div class="fix_links">
...
{%/new_elems%}
  ...
  <div class="bulle_verif">
    ...
    <a href="../error/{%uuid%} "target="_blank" title="{{_('Issue details')}}">{{_("details")}}</a>
  </div>
  <div id="bulle_footer">
    <div id="bulle_maj">
