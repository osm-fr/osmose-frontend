...
{%#elems%}
  ...
  {%/relation%}
  {%#node%}
      <a href="../josm_proxy?load_object?objects=n{%id%}" target="hiddenIframe" class="josm">josm</a>
  {%/node%}
  {%#way%}
      <a href="../josm_proxy?load_object?objects=w{%id%}" target="hiddenIframe" class="josm">josm</a>
  {%/way%}
  {%#relation%}
      <a href="../josm_proxy?import?url={{remote_url_read}}api/0.6/{%type%}/{%id%}/full" target="hiddenIframe" class="josm">josm</a>
  {%/relation%}
