...
%                if cur_type == "relation":
        <a title="josm" href="http://localhost:8111/import?url={{remote_url_read}}/api/0.6/relation/{{m.group(2)}}/full" target="hiddenIframe" onclick="$.get('http://localhost:8111/zoom?left={%minlon%}&bottom={%minlat%}&right={%maxlon%}&top={%maxlat%}'); return true;">(j)</a>
%                else:
